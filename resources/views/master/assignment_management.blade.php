...
@section('content')
    ...
    <form action="{{ url('/master/zonal_confirm_work/'.$work_entry->id) }}" method="POST">
        @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Название</label>
                            <input type="text" name="new_basis" class="form-control" value="{{ $work_entry->zonal_basis }}" disabled>
                        </div>

                        {{-- Название --}}
                        <div class="form-group">
                            <label>Описание</label>
                            <input type="text" name="new_description" class="form-control" value="{{ $work_entry->zonal_description }}" disabled>
                        </div>
